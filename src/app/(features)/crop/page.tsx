      ...
      <div className="space-y-6 p-4 sm:p-6 border rounded-lg w-full ">
        ...
        <div className="flex flex-col space-y-2">
          <Input
            ...
            className="cursor-pointer w-full lg:w-1/3 text-sm rounded-sm"
          />
        ...
        <Select onValueChange={setSelectedFormat}>
          <SelectTrigger className="w-full lg:w-1/3 rounded-sm">
        ...
        <div className="w-full">
          {loading ? (
            ...
            <div className="max-w-full mx-auto">
              {cloudinaryImage && (
                <div className="relative max-w-3xl overflow-hidden border-red-500">
                  <CldImage
                    src={cloudinaryImage}
                    alt="image"
                    width={
